...
def pythonsubmit(folder,submit=0):
    if submit !=0:
        ...
        scriptfile=submit-1
        testsubmit=['SUBMIT','SUBMITLARGE','SUBMITOLD','SUBMITUNIT', 'SUBMITSHORT'] # testsubmit[scriptfile=1]='SUBMITLARGE'
        ...
        os.system("nl job.number | sed -n '/Submitted/p' >> %s/jobs.number" % (os.environ['HOME']))
        #print('2')
